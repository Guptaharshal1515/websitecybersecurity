...
export default function Achievements() {
  ...
  const getRoleTint = () => {
    if (userRole === 'admin') return 'from-red-500/20 to-red-600/20';
    if (userRole === 'customer') return 'from-blue-500/20 to-blue-600/20';
    return 'from-primary/20 to-primary-foreground/20';
  };
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <AnimatePresence mode="wait">
                        {achievements.map((achievement, index) => (
                          ...
                          >
                            <Card className={`relative w-full h-full bg-gradient-to-br ${getRoleTint()} border-2 hover:border-primary/50 transition-all duration-300 overflow-hidden group`}>
                              {canEdit && isEditMode && (
                <DeleteButton
